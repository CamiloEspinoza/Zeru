    ...
    <div className="space-y-5">
      ...
      <Card>
        {showHeader && (
          <CardHeader>
            ...
            <CardDescription>
              Selecciona la región de AWS donde tienes habilitado SES.
            </CardDescription>
          </CardHeader>
        )}
        <CardContent>
            ...
            <div>
              ...
              <CardDescription className="mt-1">
                {config.hasCredentials
                  ...
                  : "Ingresa tus credenciales de AWS IAM con permiso ses:SendEmail. Se almacenan cifradas."}
              </CardDescription>
            </div>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Se eliminarán las credenciales almacenadas. No se podrán
                      enviar correos desde tu organización hasta que configures
                      nuevas credenciales.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={
                config.hasCredentials
                  ? "AKIA... (dejar vacío para no cambiar)"
                  : "AKIA..."
              }
              value={accessKeyId}
              onChange={(e) => {
                setAccessKeyId(e.target.value);
                if (e.target.value && secretAccessKey && fromEmail) {
              ...
              <Input
                ...
                placeholder={
                  config.hasCredentials
                    ...
                    : "Tu secret access key"
                }
                value={secretAccessKey}
                onChange={(e) => {
                  setSecretAccessKey(e.target.value);
                  if (accessKeyId && e.target.value && fromEmail) {
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Dirección verificada en SES desde la cual se enviarán los correos.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => {
                  ...
                  if (accessKeyId && secretAccessKey && e.target.value) {
                    triggerValidation({ fromEmail: e.target.value });
                  }
                }}
                disabled={isBusy}
                className={cn(
            ...
            {validationStatus === "validating" && (
              <p className="text-xs text-muted-foreground">
                Verificando credenciales SES...
              </p>
            )}
            {validationStatus === "valid" && saveStatus === "idle" && (
              <p className="text-xs text-green-600 dark:text-green-400">
                Credenciales válidas — cuenta SES accesible
              </p>
            )}
