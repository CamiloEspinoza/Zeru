...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/30 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border border-transparent bg-clip-padding text-xs/relaxed font-medium focus-visible:ring-2 aria-invalid:ring-2 [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 dark:hover:bg-teal-600",
        outline: "border-border dark:bg-input/30 hover:bg-teal-950/15 hover:text-foreground dark:hover:bg-teal-900/30 aria-expanded:bg-teal-950/15 dark:aria-expanded:bg-teal-900/30 aria-expanded:text-foreground",
        secondary: "bg-secondary text-secondary-foreground hover:bg-teal-950/20 dark:hover:bg-teal-900/40 aria-expanded:bg-teal-950/20 dark:aria-expanded:bg-teal-900/40 aria-expanded:text-secondary-foreground",
        ghost: "hover:bg-teal-950/15 hover:text-foreground dark:hover:bg-teal-900/30 aria-expanded:bg-teal-950/15 dark:aria-expanded:bg-teal-900/30 aria-expanded:text-foreground",
